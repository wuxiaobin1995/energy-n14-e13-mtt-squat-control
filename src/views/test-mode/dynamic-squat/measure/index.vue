 ...
 * @LastEditTime: 2023-06-08 14:15:32
...
<template>
  <div class="dynamic-squat-measure">
    ...
    <div class="wrapper">
      ...
      <div class="introduce">
        <div class="item">
          请双脚平稳站立在踏板上，进行5-10个下蹲动作，使滑块保持在绿色区域内，可选择睁眼/闭眼进行测试。
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      audioSrc: path.join(__static, `narrate/mandarin/Test/动态下蹲测试.mp3`),
  ...
  methods: {
    ...
    handleRefresh() {
      this.$router.push({
        path: '/refresh',
        query: {
          routerName: JSON.stringify('/dynamic-squat-measure'),
